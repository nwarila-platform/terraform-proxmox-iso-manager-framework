...
| Reference | [Terraform reference](reference/terraform.md), [Release gates](reference/release-gates.md), [Module invariants](reference/invariants.md), [Mirroring contract](reference/mirroring.md), [Runner protocol](reference/runner-protocol.md) | You need exact facts, schemas, gates, inputs, outputs, or current handoff state. |
